...
public class SegmentedButtonGroup extends LinearLayout
{
    ...
    private void getAttributes(Context context, @Nullable AttributeSet attrs)
    {
        ...
        if (ta.hasValue(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectedBackground))
            selectedBackgroundDrawable = ta.getDrawable(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectedBackground);

        // Note: Must read radius before setBorder call in order to round the border corners!
        radius = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_radius, 0);
        selectedButtonRadius = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectedButtonRadius, 0);
        ...
        // width and gap
        borderWidth = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_borderWidth, 0);
        borderColor = ta.getColor(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_borderColor, Color.BLACK);
        borderDashWidth = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_borderDashWidth, 0);
        borderDashGap = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_borderDashGap, 0);
        ...
        selectedBorderWidth = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectedBorderWidth, 0);
        selectedBorderColor = ta.getColor(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectedBorderColor, Color.BLACK);
        selectedBorderDashWidth = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectedBorderDashWidth, 0);
        selectedBorderDashGap = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectedBorderDashGap, 0);

        position = ta.getInt(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_position, 0);
        draggable = ta.getBoolean(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_draggable, false);
        ...
        ripple = ta.getBoolean(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_ripple, true);
        hasRippleColor = ta.hasValue(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_rippleColor);
        rippleColor = ta.getColor(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_rippleColor, Color.GRAY);

        final int dividerWidth = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_dividerWidth, 1);
        final int dividerRadius = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_dividerRadius, 0);
        final int dividerPadding = ta.getDimensionPixelSize(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_dividerPadding, 0);
        ...
        if (ta.getValue(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_divider, value))
        {
            if (value.type == TypedValue.TYPE_REFERENCE || value.type == TypedValue.TYPE_STRING)
            {
                ...
                if (isInEditMode())
                {
                    setDivider(ta.getDrawable(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_divider), dividerWidth, dividerRadius,
                        dividerPadding);
                }
                else
                {
        ...
        int selectionAnimationInterpolator = ta.getInt(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectionAnimationInterpolator,
            ANIM_INTERPOLATOR_FAST_OUT_SLOW_IN);
        setSelectionAnimationInterpolator(selectionAnimationInterpolator);
        selectionAnimationDuration = ta.getInt(R.styleable.SegmentedButtonGroup_segmentedButtonGroup_selectionAnimationDuration, 500);
